/**
 * @file features/reports/data/chile-locations.ts
 * @description Dataset de las 16 regiones de Chile con sus comunas.
...
export const CHILE_REGIONS: Region[] = [
  ...
  },
  {
    ...
    label: 'Valparaíso',
    comunas: [
      'Algarrobo', 'Cabildo', 'Calera', 'Cartagena', 'Casablanca',
      'Catemu', 'Concón', 'El Quisco', 'El Tabo', 'Hijuelas',
      'Isla de Pascua', 'Juan Fernández', 'La Cruz', 'La Ligua',
  ...
  },
  {
    ...
    comunas: [
      ...
      'San Ramón', 'Santiago', 'Tiltil', 'Vitacura',
    ],
  },
  {
    value: 'ohiggins',
